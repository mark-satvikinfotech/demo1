...
if(isset($_REQUEST['DoceboIdEmail']) && $_REQUEST['DoceboIdEmail'] != '' && $_REQUEST['DoceboIdEmail'] != null && ((isset($_REQUEST['CourseCode']) && $_REQUEST['CourseCode'] != '' && $_REQUEST['CourseCode'] != null) || (isset($_REQUEST['CourseId']) && $_REQUEST['CourseId'] != '' && $_REQUEST['CourseId'] != null))){
	require('../../../wp-load.php');
	...
	// add user to course
	if(isset($_REQUEST['TotalSeats']) && $_REQUEST['TotalSeats'] != null && $_REQUEST['TotalSeats'] != ''){
		$numSeat = $_REQUEST['TotalSeats'];
	} else {
		$numSeat = '1';
	}
