<div class="wrap">
<h2>DoceboLabs - Add a Power User to a course</h2>
<div class="bf_docebolabs_container">
	<a href="admin.php?page=bf_docebolabs_menu-home">&lt; Back to More Docebolabs Scripts</a>
	<h3>What it does</h3>
	<p class="descriptive">Add Power User plus free extra seats to a specific course via HTTP Post</p>
		...
		<table>
			<?php
				$fields = array(
					...
					'TotalSeats' => 'Set the total number of seats required i.e, initial seat plus free extra seats (if not provided will default to 1)'
				);
