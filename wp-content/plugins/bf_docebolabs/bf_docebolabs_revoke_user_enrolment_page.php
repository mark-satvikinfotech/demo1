<div class="wrap">
<h2>DoceboLabs - Revoke a user's access to a course</h2>
<div class="bf_docebolabs_container">
	<a href="admin.php?page=bf_docebolabs_menu-home">&lt; Back to More Docebolabs Scripts</a>
	<h3>What it does</h3>
	<p class="descriptive">Revoke a user's access to a particular course via HTTP Post</p>
	...
	<div class="isview">
		<p class="istext">POST URL</br><div class="isbox" style="max-width: 100%;"><?php echo plugin_dir_url( __FILE__ )."bf_docebolabs_revoke_user_enrolment.php";?></div></p>
