...
if(isset($_REQUEST['DoceboIdEmail']) && $_REQUEST['DoceboIdEmail'] != '' && $_REQUEST['DoceboIdEmail'] != null && isset($_REQUEST['ProfileName']) && $_REQUEST['ProfileName'] != '' && $_REQUEST['ProfileName'] != null){
	require('../../../wp-load.php');
	...
	$submiturl = "https://".$subdomain.".docebosaas.com/api/poweruser/update";
	$data = array('id_user' => $userid, 'profile_name' => $_REQUEST['ProfileName']);
