	...
	public static function SSM_subscriber_CardList()
	{
        ...
        try
        {
            ...
            {            	
                ...
                <div class="all-subscriptions">
                    <div class="add-card">
                        <button type="button" id="add_new_card"  class="inactive_btn"><i class="fas fa-plus"></i>Add a Card</button>
                    </div>
							...
							if (count($cards) > 0)
							{
								...
								?>
									<div class="visa clearfix">
										<div class="visa-img">
											<img src="<?php echo plugin_dir_url(__FILE__).'images/'.$cards[0]->brand.'.jpg'; ?>" alt="">

										</div>
										<span>Visa debit card ...<?php echo $cards[0]->last4 . ' expires on ' . $exp_data; ?> </span>
										<div class="visa-edit">
											<a href="javascript:void(0)" onclick="update_selected_card('<?php echo $card_id; ?>', '<?php echo $customer_id; ?>','<?php echo $q;?>');"><i class="fas fa-cog"></i>Edit</a>
										</div>
									</div>
